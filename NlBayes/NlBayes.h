 ...
 * @return none.
 **/
void estimateSimilarPatchesStep1(std::vector<float> const &i_im,
 ...
 **/
unsigned estimateSimilarPatchesStep2(std::vector<float> const &i_imNoisy,
 ...
 **/
int computeHomogeneousAreaStep1(std::vector<std::vector<float> > &io_group3d,
                                const unsigned p_sP,
 ...
 * @return 1 if an homogeneous area is detected, 0 otherwise.
 **/
int computeHomogeneousAreaStep2(std::vector<float> const &i_group3dNoisy,
