 ...
 *
 * @param io_mat : array containing a symmetric input matrix. This is converted to the inverse matrix;
 ...
 **/
int inverseMatrix(vector<float> &io_mat, const unsigned p_N) {
  //! Initializations
  float z;
...
void transposeMatrix(
    vector<float> &io_mat, const unsigned p_N
) {
...
void covarianceMatrix(
    vector<float> const &i_patches, vector<float> &o_covMat, const unsigned p_nb, const unsigned p_N
) {
